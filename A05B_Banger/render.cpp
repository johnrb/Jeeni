/* D_OneKeyPiano_ToneVary
One key piano with variable pitch and tone from acoustic to electric.
A BELA Project by John Buschert
Dependencies:  Bela.h, tsf.h, JRBDuoPiano.sf2
*/
...
const char *filename = "JRBDuoPiano.sf2";
const char *presetNames[25];
int preset1 = 0; // Piano preset
int preset2 = 3; // Electric Piano preset
